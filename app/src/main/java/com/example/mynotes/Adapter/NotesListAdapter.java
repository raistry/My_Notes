...
class NotesViewHolder extends RecyclerView.ViewHolder{
    ...
    public NotesViewHolder(@NonNull View itemView) {
        ...
        notes_conteiner = itemView.requireViewById(R.id.notes_conteiner);
        textView_title = itemView.requireViewById(R.id.textView_title);
        imageView_pin = itemView.requireViewById(R.id.imageView_pin);
        textView_notes = itemView.requireViewById(R.id.textView_notes);
        textView_date = itemView.requireViewById(R.id.textView_date);
